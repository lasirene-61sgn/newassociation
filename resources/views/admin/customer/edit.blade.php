...
<div class="p-6 md:p-8">
    ...
    <div class="flex items-center space-x-3 mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Edit Member Profile</h2>
    </div>
        ...
        <form action="{{ route('admin.customer.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div>
                    ...
                    @if($customer->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $customer->image) }}" alt="Customer Photo" class="w-12 h-12 object-cover rounded-full border">
                        </div>
                    @endif
                    <input type="file"
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="father_name" name="father_name" value="{{ old('father_name', $customer->father_name) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="gotra" name="gotra" value="{{ old('gotra', $customer->gotra) }}">
            ...
            {{-- Family Lineage & Parents Information --}}
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <input type="text"
                        ...
                        id="mother_name" name="mother_name" value="{{ old('mother_name', $customer->mother_name) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="grand_father_name" name="grand_father_name" value="{{ old('grand_father_name', $customer->grand_father_name) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="grand_mother_name" name="grand_mother_name" value="{{ old('grand_mother_name', $customer->grand_mother_name) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    @if($customer->father_photo_path)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $customer->father_photo_path) }}" alt="Father Photo" class="w-12 h-12 object-cover rounded-lg border">
                        </div>
                    @endif
                    <input type="file"
                ...
                <div>
                    ...
                    @if($customer->mother_photo_path)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $customer->mother_photo_path) }}" alt="Mother Photo" class="w-12 h-12 object-cover rounded-lg border">
                        </div>
                    @endif
                    <input type="file"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" maxlength="10"
                        ...
                        id="pan_card_no" name="pan_card_no" value="{{ old('pan_card_no', $customer->pan_card_no) }}">
                ...
                <div>
                    ...
                    <input type="text" maxlength="12"
                        ...
                        id="aadhar_no" name="aadhar_no" value="{{ old('aadhar_no', $customer->aadhar_no) }}">
            ...
            <div class="mb-6 flex items-center">
                <input type="checkbox"
                    ...
                    id="is_trust_working_board" name="is_trust_working_board" value="1" {{ old('is_trust_working_board', $customer->is_trust_working_board) ? 'checked' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="label_name" name="label_name" value="{{ old('label_name', $customer->label_name) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="ms_firm_name" name="ms_firm_name" value="{{ old('ms_firm_name', $customer->ms_firm_name) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="dno" name="dno" value="{{ old('dno', $customer->dno) }}">
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    ...
                    id="street_road" name="street_road" value="{{ old('street_road', $customer->street_road) }}">
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    ...
                    id="address2" name="address2" value="{{ old('address2', $customer->address2) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="pincode" name="pincode" value="{{ old('pincode', $customer->pincode) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number"
                        ...
                        id="age" name="age" value="{{ old('age', $customer->age) }}">
                ...
                <div>
                    ...
                    <input type="date"
                        ...
                        id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $customer->date_of_birth ? \Carbon\Carbon::parse($customer->date_of_birth)->format('Y-m-d') : '') }}">
                ...
                <div>
                    ...
                    <input type="date"
                        ...
                        id="anniversary_date" name="anniversary_date" value="{{ old('anniversary_date', $customer->anniversary_date ? \Carbon\Carbon::parse($customer->anniversary_date)->format('Y-m-d') : '') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="business_type" name="business_type" value="{{ old('business_type', $customer->business_type) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="business_name" name="business_name" value="{{ old('business_name', $customer->business_name) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="product_service" name="product_service" value="{{ old('product_service', $customer->product_service) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="education" name="education" value="{{ old('education', $customer->education) }}">
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="blood_group" name="blood_group" value="{{ old('blood_group', $customer->blood_group) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <textarea class="form-textarea w-full px-4 py-2 border rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 @error('hobbies') border-red-500 @enderror"
                        id="hobbies" name="hobbies" rows="2">{{ old('hobbies', $customer->hobbies) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text"
                        ...
                        id="native_place" name="native_place" value="{{ old('native_place', $customer->native_place) }}">
            ...
            <div class="mb-6">
                ...
                @if($customer->background_image)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $customer->background_image) }}" alt="Background Image" class="w-24 h-12 object-cover rounded-lg border">
                    </div>
                @endif
                <input type="file"
            ...
            <div class="pt-4 border-t border-gray-100 flex gap-3">
                ...
                <a href="{{ session('customer_index_url', route('admin.customer.index')) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    Cancel
                </a>
            </div>
        </form>
...
<script>
    ...
    // Load existing payments or repopulate old inputs
    @php
        $paymentsToRender = old('payment_details', $customer->payment_details ?? []);
    @endphp

    const savedPayments = @json($paymentsToRender);
    if (Array.isArray(savedPayments) && savedPayments.length > 0) {
        savedPayments.forEach(item => renderPaymentRow(item));
    } else if (typeof savedPayments === 'object' && savedPayments !== null) {
        Object.values(savedPayments).forEach(item => renderPaymentRow(item));
    }
</script>
@endsection